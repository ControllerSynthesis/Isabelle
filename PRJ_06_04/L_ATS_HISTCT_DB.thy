...
assumes AX_is_forward_target_deterministic_correspond_DB: "
  TSstructure G
  \<Longrightarrow> is_forward_target_deterministic_accessible G = is_forward_target_deterministicHist_DB_long G"
