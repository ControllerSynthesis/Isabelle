...
assumes AX_is_forward_edge_deterministic_correspond_SB: "
  TSstructure G
  \<Longrightarrow> is_forward_edge_deterministic_accessible G = is_forward_edge_deterministicHist_SB_long G"
