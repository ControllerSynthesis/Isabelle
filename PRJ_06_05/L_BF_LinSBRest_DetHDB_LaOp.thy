section {*L\_BF\_LinSBRest\_DetHDB\_LaOp*}
theory
...
print_locale ATS_Sched_SB

locale BF_LinSBRest_DetHDB_LaOp =
...
assumes AX_BF_LinSBRest_DetHDB_LaOp: "
  TSstructure M
  ...
  \<Longrightarrow> Nonblockingness_linear_restricted M"
