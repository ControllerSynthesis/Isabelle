section {*L\_BF\_BraDBRest\_DetHSB\_LaOp*}
theory
...
locale BF_BraDBRest_DetHSB_LaOp =
...
assumes AX_BF_BraDBRest_DetHSB_LaOp: "
  TSstructure M
  ...
  \<Longrightarrow> Nonblockingness_branching_restricted_DB M"
